...
import { lockScroll, matchMedia } from "@/utils";
import type { MediaQuerySize } from "@/utils";
...
export class Drawer {
  ...
  constructor({
    ...
    isAutoFocus = false,
    ...props
  }: Pick<Drawer, "triggerButton" | "closeButton" | "targetMenu" | "targetMenuItems" | "mediaQuery" | "isAutoFocus">) {
